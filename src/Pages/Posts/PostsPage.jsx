...
const PostsPage = () => {
  return (
    <>
     ...
     <div className=" w-[100%] mt-20   flex flex-col font-OpenSans">
      <div className=" pb-20 w-[75%] m-auto flex flex-col bg-[#FFFFFF] gap-10">
        <h1 className=" text-2xl font-bold">10 Reasons to Build Your Website with WP Page Builder</h1>
        <div className=" ">
            <p className=" font-semibold ">People’s quest for creating websites has easily taken us to a new era of site development. Where, with the availability of robust page building tools, creating websites has become a lot more fun (especially for non-developers).</p>
        </div>
        ...
        <div className=" flex justify-between">
         ...
         <div className=" pb-4">  <a className=" " href="http://" > <img src="/Facebook.png"/> </a>    </div>
          ...
          <div className="">
           ...
           <FaHeart className=" text-[#FF5480]" size={27}/>
            <p>12K</p>
           </div>
           <div className="grid">
           <FaEye size={27}/>
	...
	<p  className="py-4"> <span  className=" font-semibold">•	Carousel:</span> It’s hard to find an advanced add-on like a carousel in a free page builder plugin, but WP Page Builder lets you create stunning hero sliders without having to pay for it.</p>
	<p  className="py-4"> <span  className=" font-semibold"> •	Post Grid:</span> Display blog posts in grids defining the number of posts and styling the look.</p>
	<p  className="py-4"> <span  className=" font-semibold"> •	Feature Box:</span> Use the Feature Box add-on to display the features of products on your website.</p>
	<p  className="py-4"> <span  className=" font-semibold"> •	Accordion:</span> Need any collapse text content on your site? Use WP Page Builder’s Accordion add-on and modify the style the way you want.</p>
      ...
      <div className="flex flex-col">
        ...
        <h1>TOMAS LAURINAVICIUS</h1>
        <span className=" flex">
        <span>Follow me</span> <span><a className=" text-[#27AEFF]" href=""> @JohnAMWill.</a></span>
        </span>
        </div>
     ...
     <div className=" p-8">
      ...
      <a className=" text-[#9B9B9B]" href="#">More</a>
      </div>
...
Thrive architect from thrivethemes. That thing is pretty powerful.</p>
        ...
        <div className=" flex justify-center pb-20" >
          <div className=" bg-[#FFFFFF] w-[772px] h-[772px] rounded-lg shadow-sm  shadow-gray-500">
            <div className=" items-center place-content-center w-full h-full flex">
            <form className=" flex flex-col ">
            <label>Leave a Reply</label>
            <div className="py-4  w-[523px] h-[196px] border-2 border-gray-200 rounded-lg">
            ...
            <div className="py-4">
            <input className=" focus:outline-none w-[523px] h-[70px] border-2 rounded-lg border-gray-200 placeholder:font-OpenSans placeholder:text-base pl-6 placeholder:pl-1" placeholder="Name" type="name"/>
            </div>
            <div className="py-4" >
            <input className=" focus:outline-none w-[523px] h-[70px] border-2 rounded-lg border-gray-200 placeholder:font-OpenSans placeholder:text-base pl-6 placeholder:pl-1" placeholder="Email" type="email"/>
            </div>
            ...
            <div className="py-4">
            <button className=" bg-[#FF5480] h-[70px] text-white rounded-[35px] w-[227px]">Post Comment</button>
            </div>
            </form>
            </div>
          </div>
